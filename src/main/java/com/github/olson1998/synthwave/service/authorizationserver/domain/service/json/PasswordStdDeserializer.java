...
class PasswordStdDeserializer extends AbstractObjectStdDeserializer<Password> {
    ...
    @Override
    protected Password deserializeObjectNode(ObjectNode objectNode, ObjectCodec objectCodec, JsonParser p, DeserializationContext ctxt) throws IOException, JacksonException {
