...
public class OAuth2TokenCustomizingService implements OAuth2TokenCustomizer<JwtEncodingContext> {
    ...
    public void customize(JwtEncodingContext context) {
        if(context.getPrincipal() instanceof UsernamePasswordAuthenticationToken usernamePasswordAuthenticationToken &&
            ...
            context.getClaims().claims(jwtClaims -> {
                ...
                jwtClaims.put("DIVI", synthwaveUser.getDivision());
            });
        }
    }
}
