...
@Repository
interface PostLogoutRedirectUriBindingJpaRepository extends JpaRepository<PostLogoutRedirectUriBindingData, PostLogoutUriBindingValue> {

    @Modifying
    @Query("""
           DELETE FROM PostLogoutRedirectUriBindingData binding
           WHERE binding.properties.postLogoutUriId IN :idCollection
